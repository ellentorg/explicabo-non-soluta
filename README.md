<div align="center">
  ...
  <h1>@ellentorg/explicabo-non-soluta</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/ellentorg/explicabo-non-soluta/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/ellentorg/explicabo-non-soluta/actions)

## Installation

```bash
yarn add --dev eslint @ellentorg/explicabo-non-soluta
```

**Note:** If you installed ESLint globally then you must also install
`@ellentorg/explicabo-non-soluta` globally.
...
```js
const jest = require('@ellentorg/explicabo-non-soluta');
...
💼
[Configurations](https://github.com/ellentorg/explicabo-non-soluta/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/ellentorg/explicabo-non-soluta/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/ellentorg/explicabo-non-soluta/blob/main/README.md#shareable-configurations).\
🎨 Set in the `style` [configuration](https://github.com/ellentorg/explicabo-non-soluta/blob/main/README.md#shareable-configurations).\
...
### @ellentorg/explicabo-non-soluta-extended

This is a sister plugin to `@ellentorg/explicabo-non-soluta` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/ellentorg/explicabo-non-soluta-extended>

### @ellentorg/explicabo-non-soluta-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@ellentorg/explicabo-non-soluta-formatting>
